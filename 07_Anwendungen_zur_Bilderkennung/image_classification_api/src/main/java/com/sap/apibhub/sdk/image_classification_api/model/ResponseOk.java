...
import com.sap.apibhub.sdk.image_classification_api.model.ClassificationResult;
...
public class ResponseOk {
  ...
  private List<ClassificationResult> predictions = null;

  /**
   * Indicator of classification success
   */
  ...
  **/
  ...
  public ResponseOk predictions(List<ClassificationResult> predictions) {
    this.predictions = predictions;
    return this;
  }

  public ResponseOk addPredictionsItem(ClassificationResult predictionsItem) {
    if (this.predictions == null) {
      this.predictions = new ArrayList<ClassificationResult>();
    }
  ...
  **/
  ...
  public List<ClassificationResult> getPredictions() {
    return predictions;
  }

  public void setPredictions(List<ClassificationResult> predictions) {
    this.predictions = predictions;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(value = "Indicator of classification success")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, predictions, status);
  }
