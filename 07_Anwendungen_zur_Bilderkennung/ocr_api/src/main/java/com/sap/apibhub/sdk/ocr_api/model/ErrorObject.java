...
import com.sap.apibhub.sdk.ocr_api.model.EmbeddedResponseError;
...
public class ErrorObject {
  ...
  public ErrorObject requestId(String requestId) {
   ...
   /**
   * Request ID, as it appears in the logs.
   * @return requestId
  **/
  @ApiModelProperty(value = "Request ID, as it appears in the logs.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Technical code of the error, to be used for support purposes.")
