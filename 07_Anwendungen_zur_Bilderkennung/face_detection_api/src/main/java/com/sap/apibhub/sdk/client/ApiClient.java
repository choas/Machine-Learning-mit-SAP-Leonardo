...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.api.sap.com/ml/api/v2alpha1/image";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.api.sap.com/ml/api/v2alpha1/image
