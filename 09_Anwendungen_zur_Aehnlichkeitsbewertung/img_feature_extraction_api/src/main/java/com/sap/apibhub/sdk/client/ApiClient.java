...
public class ApiClient {
    ...
    private String basePath = "https://sandbox.api.sap.com/mlfs/api/v2/image";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.api.sap.com/mlfs/api/v2/image
